...
module.exports.init = function (editor) {
	// https://api.cloudinary.com/v1_1/df76yiogz/resources/image/tags/SFCCPageDesigner
    // var jsonString = Site.getCurrent().getCustomPreferenceValue('cloudinary_overlay_json');
